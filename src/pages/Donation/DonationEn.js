...
const DonationEn = () => {
    return (
        <Box w="100%" maxW="container.xl" mx="auto" p={5}>
            ...
            <Text color="#c8d9df" fontSize={20} fontWeight="bold" mb={5}>
                ...
                <TabPanels>
                    ...
                    <TabPanel>
                        <Flex direction="column" alignItems="center">
                            ...
                            <Image src={require("../../images/mobile2.png")} alt="image2" height={800} mb={5} />
                            <Text fontSize={20} mb={5}>
                                <p>4. '다음'을 누르면 확인 화면이 표시됩니다. 여기에 결제할 가스 요금을 포함한 거래의 세부 정보가 표시됩니다.</p>
                            </Text>
                            <Image src={require("../../images/mobile3.png")} alt="image2" height={800} mb={5} />
                            <Text fontSize={20} mb={5}>
