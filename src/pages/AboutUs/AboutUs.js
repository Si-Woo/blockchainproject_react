...
const AboutUs = () => {
    ...
    return (
        <Box w="100%" maxW="container.xl" mx="auto" textAlign="center">
            ...
            <HStack marginLeft={16} wrap="wrap" spacing={2}>
                <Text fontSize={24} fontWeight="bold" color="white" mb={3} textAlign="start">
                    ·
                </Text>
                <Text fontSize={22} color="white" mb={3} textAlign="start">
                    {t("이메일") + ":"}
                </Text>
